...
* СУБД:  Реляционная (RDBMS),  как  PostgreSQL  или  MySQL.
...
Модель  распределенных  вычислений:  MapReduce  -  классическая  модель  распределенных  вычислений,  которая  отлично  подходит  для  больших  объемов  данных. 
